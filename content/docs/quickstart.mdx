...
<Cards>
  <Card title="Backend reference" href="/docs/node" description="Every @trueyy-sdk/node API: interviews, team, tokens, reports, billing, webhooks, errors." />
  <Card title="Frontend reference" href="/docs/web" description="TrueyyProvider, TrueyyMonitor, TrueyyJoin, TrueyyReplay, and the hooks." />
</Cards>
